...
@Component({
  selector: 'app-form-dyanmic-demo',
  templateUrl: './form-dyanmic-demo.component.html',
  styleUrls: ['./form-dyanmic-demo.component.css']
})
export class FormDyanmicDemoComponent implements OnInit{
